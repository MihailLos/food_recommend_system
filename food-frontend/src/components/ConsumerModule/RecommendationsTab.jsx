      ...
      <div style={{ ...box, padding: 16, display: "grid", gap: 12 }}>
        ...
        >
          ...
          <div style={{ border: "1px solid #d9e2ee", borderRadius: 10, padding: "10px 12px", background: "#f8fbff", color: "#34495e", fontSize: 13, lineHeight: 1.55 }}>
            ...
            <div>Для полноценного расчёта рекомендаций нужно не менее 4 продуктов. По каждому выбранному пищевому веществу данные должны быть известны минимум у 4 продуктов из этого множества.</div>
            <div style={{ marginTop: 6 }}>Алгоритм распределяет продукты по четырём квартильным уровням и присваивает баллы от 1 до 4. Если продуктов или данных по веществу меньше четырёх, часть уровней не формируется, то есть сравнение остаётся технически возможным, но квартильные баллы, итоговый процент и класс рекомендации становятся неполными или малоинформативными.</div>
            <div style={{ marginTop: 6 }}>При выполнении этих условий все этапы алгоритма рассчитываются корректно. Оценка показывает положение продукта только среди текущего множества сравнения.</div>
          </div>
